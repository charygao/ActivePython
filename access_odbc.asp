...
#用odbc连接access数据库
odbc_connection_str = 'Driver={Microsoft Access Driver (*.mdb)};DBQ=E:\mysite\ActivePython\database\#demo.mdb;Uid=;Pwd=;'
...
#调用数据
sql= u"select userID,用户姓名,用户登录名,password密码,departmentID from test"
cursor.execute(sql)
row=cursor.fetchone()
...
<div class="clear_fixed">
	<dl class="addlist">
		...
		<dt><li>ActivePython使用ODBC连接Accesss数据库</li></dt>
	</dl>
</div>
2.body_Table内容
<div class="clear_fixed">
